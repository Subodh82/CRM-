...
function Mgviewenq() {
       ...
       const updateenq = async (e) => {
          ...
          const update = {
            assignto: uid,
            assignby: localStorage.getItem("manager"),
            assigndate: d,
          };
                      ...
                      <td>
                        ...
                        >
                          ...
                          <div className="dropdown">
                            <button className="btn btn-secondary btn-sm" data-bs-toggle="dropdown">
